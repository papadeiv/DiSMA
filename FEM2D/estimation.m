function [u,e_inf,e_L2,e_H1] = estimation(u_h, N)
    ...
    for j=1:N
        u(j) = exact_functions{1}(nodes(j,3),nodes(j,4),t);
    end
    ...
    if Ndof==3
        ...
        for e=1:length(triangles(:,1))
            ...
            for q=1:Nq
                ...
                error_L2(q) = omega(q)*(exact_functions{1}(mapped_x, mapped_y,t) - sum_L2)^2;
                u_diff = [exact_functions{2}(mapped_x, mapped_y,t); exact_functions{3}(mapped_x, mapped_y,t)] - sum_H1;
