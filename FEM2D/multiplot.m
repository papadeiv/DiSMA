function [] = multiplot(time, multi, Ns, m, z_h, z)
    ...
    if multi=='Y' % PLOT GRID-CONVERGENCE
    ...
    elseif time > 0 % PLOT TIME-CONVERGENCE
        ...
        title('Time-step (t) = ', t)
        % change azimuth's and elevation's angle of the camera
        view(75,30) % view(45,0)
        % label the axis
        xlabel('x')
        ylabel('y')
        
    else % SINGLE-PLOT NUMERICAL SOLUTION
